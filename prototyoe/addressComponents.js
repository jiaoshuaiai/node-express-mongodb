...
import BaseComponent from './baseCompentent.js';

class AddressComponent extends BaseComponent {
	constructor(){
		super();
		this.tencentkey = '62WBZ-M5KHG-AL3QX-IE6NF-RZXDV-QPB3B';
		this.tencentkey2 = 'RRTBZ-IDVRG-MWRQT-IDWKD-LSMX7-YXBGW';
		this.baidukey='GnvzSilILgssEcFYBfEEDjFQGWut4TDR';
		this.baidukey2='FTYPCqfDyGxGoCpSfc0qqlQ5EQhwu1wH';
	}
//获取定位地址
